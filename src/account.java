...
public class account {
    ...
    static final String FROM = "pavansadhineni22@gmail.com";
    static final String FROMNAME = "cars4u";
	
    
    public static   String TO ;
   static final String SMTP_USERNAME = "pavansadhineni22@gmail.com";
    
    
    static final String SMTP_PASSWORD = "chowdary@0707";
    ...
    public static void otpsend(String eemail,int a) throws Exception
    {
    	 String BODYotp = String.join(
    	    	    System.getProperty("line.separator"),
    	    	    "<h1>CARS4U</h1> ",
    	    	   "<br>",
    	    	    "<hr>",
    	    	   
    	    	    "<p>This email was sent because for otp in our cars4u website</p>", 
    	    	    "<p>you can rent various cars in our cars4u website at  reasonable prices</p>",
    	    	    "<p>CARS4U main theme is even normal people to travel in top rated cars at</p>",
    	    	    "<p> low prices . visit our website when you are free.</p>",
    	    	    "<hr>",
    	    	    "<center><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjFCw8zcAribeQV9Do5_-GQqtRyy_4Fzek5A&usqp=CAU'width=\"600\" height=\"150\"/></center>",
    	    	    "<h2><b><i>Thank you for using  cars4u website</b></i></h2>"
    	    	);
    	Properties props = System.getProperties();
    	props.put("mail.transport.protocol", "smtp");
    	props.put("mail.smtp.port", PORT); 
