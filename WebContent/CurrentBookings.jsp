...
<div class="topnav-right">
 <a href="PastBookings.jsp" >Past Bookings</a>
   <a href="CurrentBookings.jsp" style="background-color:steelblue">Current Bookings</a>
...
PreparedStatement p=connection.prepareStatement("select * from CurrentBookings where usermail=?");
...
while(resultSet.next()){
	i=i+1;
%>
<form action="ReturnVech" method="post">
 <tr>
...
<td><%=resultSet.getString("Totalcost") %></td>
<td><button type="submit" class="btn1" id=<%=resultSet.getInt("id")%>  value=<%=resultSet.getInt("id") %> onclick="reply_click(this.id)"name="but"  style="float:right">Return</button></p></td>
 </form>
</tr>
...
if(i==0)
{
	out.println("you dont have any current bookings available");
}
connection.close();
} catch (Exception e) {
e.printStackTrace();
