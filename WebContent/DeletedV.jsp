...
%>
		...
		%>
		 ...
		 <button class="button" onclick="openForm()" style="vertical-align:middle"><span>Add Vechicle</span></button>
     
    <div class="form-popup" id="myForm">
  <form action="Addback" method="post" class="form-container">
