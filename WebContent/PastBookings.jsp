...
<div class="topnav-right">
 <a href="PastBookings.jsp" style="background-color:steelblue">Past Bookings</a>
...
PreparedStatement p=connection.prepareStatement("select * from AllBookings where user_mail=?");
