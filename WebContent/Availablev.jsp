...
%>
		...
		%>
		 ...
		 <button class="button" onclick="openForm()" style="vertical-align:middle"><span>Delete Vechicle</span></button>
      <button class="button" style="vertical-align:middle;background-color: #4CAF50; "><span>Add Vechicle</span></button>
    <div class="form-popup" id="myForm">
  <form action="DeleteVechicle" method="post" class="form-container">
    <label for="V_id"><b>Vechicle Id</b></label>
    <input type="text" placeholder="Enter Vechicle Id" name="V_id" required>
    ...
    <button type="button" class="btn cancel" onclick="closeForm()">Cancel</button>
      ...
      <form method="post" action="Updatecost" name="form" style="width:20%;margin: 80px ;" class="w3-container w3-card-4 w3-padding-16 w3-white"  target="_blank" >
      <h3 style="color:blue;font-size: 1.3em">Update Cost Of Vechicle</h3>
      ...
      <div class="w3-section">      
        ...
        <input class="w3-input" type="text" name="cost" placeholder="give new cost" required>
      </div>
      <button type="submit" class="w3-button w3-right w3-theme">Modify</button>
      </form>
